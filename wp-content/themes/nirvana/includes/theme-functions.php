...
function nirvana_site_info() {
	...
	<?php _e('Powered by','EasySoftTech')?> <a target="_blank" href="<?php echo 'https://github.com/easysofttech';?>" title="<?php echo 'EasySoftTech Theme by '. 'EasySoftTech';?>"><?php echo 'EasySoftTech' ?></a> 
  <!-- &amp; -->
